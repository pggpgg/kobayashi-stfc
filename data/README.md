...
- **Checked-in combat subset:** Regenerate with e.g. `--from-upstream --rid 2232304457,1914017763,2207112158,2488759501,3666105341,3016411865,3814450797,1240350440,1016099357` (last run produced 9 catalog items; rids with only flat unmapped buffs emit no rows).
