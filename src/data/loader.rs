...
use crate::data::hostile::{load_hostile_index, load_hostile_record, HostileRecord, DEFAULT_HOSTILES_INDEX_PATH};
use crate::data::ship::{load_ship_index, load_ship_record, ShipRecord, DEFAULT_SHIPS_INDEX_PATH};
...
pub fn resolve_hostile(name_or_id: &str) -> Option<HostileRecord> {
    ...
    // Exact id match (filename without .json)
    ...
    // "Hostile Name 33" or "hostile_name_33"
    ...
    // By hostile_name only if unique at that level (e.g. "Actian Apex" -> first match)
