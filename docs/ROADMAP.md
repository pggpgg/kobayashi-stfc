...
1. **Main lane (serialized):** ~~**12** (engine decomposition)~~ **done** → ~~**4** (Phase 4d)~~ **done** → ~~**5** (dual-gate research mapping)~~ **done** → **6** (hostile-ability audit report can start anytime; *closing* its gaps lands in the now-decomposed engine). **6 is the next pickup.**
