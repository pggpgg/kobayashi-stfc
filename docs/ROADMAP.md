...
_Last updated 2026-06-15. The June 2026 audit backlog (engine decomposition, assurance gates, upstream drift automation, June patch content, import faction resolution, and related prep) is **shipped**. Durable design detail lives in linked docs, not here._
