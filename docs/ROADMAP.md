...
- **Further catalog work** — Opponent ship-class conditions (Explorer / Battleship / Interceptor), more faction tags, and hostile debuff modeling are candidates for future resolver/scenario work; see the noop audit buckets.
