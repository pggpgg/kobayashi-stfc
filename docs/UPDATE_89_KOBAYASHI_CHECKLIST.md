...
- [ ] Tests: Mara round-start shield repair (done); optional calibration if fixtures exist
...
*Last updated: 2026-04-20 — Borg Sphere passives + `conqueror_borg` tagging; Evolutionary Assimilation instant-loss roster check in combat engine; Quantum Resonance / Hyperthermic beams still open.*
