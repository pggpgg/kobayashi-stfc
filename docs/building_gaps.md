...
| `buff_2099277663` | Reduces the cost of 7★ Crystal, Gas, and Ore for Station upgrades. | Starfleet Academy: Remote Campus |
| `buff_2101517349` | Increases Apex Barrier against non-Armada Hostiles (does not apply when Tal is assigned to the bridge). | Starfleet Academy: Remote Campus |
...
| `buff_3171687260` | Increases Critical Hit Damage for FKR ships against players. | The Facade |
...
| `buff_3302479690` | Increases the amount of Σ-Parsteel, Σ-Tritanium, and Σ-Dilithium gained in the Academy Refinery. | Starfleet Academy: Remote Campus |
...
| `buff_3310569940` | Increases Apex Barrier against players (does not apply when Tal is assigned to the bridge or when defending your Station). | Starfleet Academy: Remote Campus |
...
| `buff_3380254177` | Increases base Shield Health for all ships. | The Facade |
...
| `buff_341625291` | Increases Critical Mitigation against all Academy [ACAD] hostiles in Academy systems and Duo Wave Defense. | Starfleet Academy: Remote Campus |
...
| `buff_3880246977` | Unlocks a free daily claim of Enhanced Archive Shards in the Building Resources section in Gifts | INDEPENDENT ARCHIVES |
